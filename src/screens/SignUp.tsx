...
const SignUp = () => {
  return (
    <section className="bg-white flex flex-col rounded-[24px] fixed left-[30px] 2xl:left-[100px] top-[122px] p-10 font-semibold gap-2 w-full max-w-[520px] scale-90 2xl:scale-100">
